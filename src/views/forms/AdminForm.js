...
let AdminForm=props=>{
    ...
    return (
      <form onSubmit={handleSubmit} initialValues="{id:11}">
      <Field name="id" component="input" type="text" />
        ...
        <FormGroup className="form-actions">
          <Button type="submit" color="primary" disabled={pristine || submitting}>保存</Button>&nbsp;&nbsp;
                    <Button onClick={reset} color="secondary">取消</Button>
        </FormGroup>
        {/*   <div>
